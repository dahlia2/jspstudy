...
<body>
	...
	<script>
		...
		/* 함수 정의 */
		function fnInit(){
			$('#id').val('').prop('disabled', false);  // 조회 기능이 동작할 때 처리된 disabled 속성을 없앤다.  /* 혹은 (readOnly, false)*/
			$('#name').val('');
			...
			$('#btn_remove').prop('disabled', true);  // 조회 기능이 동작하지 않으면 회원삭제 버튼을 사용할 수 없다.   /* 체크돼있는 radio의 체크를 풀어줌 */
		}
