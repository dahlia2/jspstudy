...
public class BindingServlet1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		// 1. HttpServletRequest의 전달이 없는 이동 : redirect, <a href="">, locaion.href=""   // <a>태그와 location속성은 redirect와 같은 기능을 갖는다.
		// response.sendRedirect("/01_Servlet/BindingServlet2");
		
		// 2. HttpServletRequest의 전달이 있는 이동 : forward   // forward는 URLMapping만 적어야 함.
