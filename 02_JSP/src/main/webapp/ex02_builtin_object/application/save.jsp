...
<body>
	...
	<%
		...
		// 작성 IP
		String ip = request.getRemoteAddr();   // 요청한 클라이언트 ip를 알 수 있음
		...
		*/
		...
		// 파일명 : 작성IP_작성일.txt
		String filename = ip.replace('.', '_').replace(':', '_') + "_" + createdDate.replace("-", "");  
		// String filename = ip.replaceAll("[.:]", "_") + "_" + createdDate.replace("-", ""); 
