...
<body>
	...
	<div>
		...
		<input type="number" value="begin" id="begin" min="0" max="100" placeholder="begin">
		~
		<input type="number" value="end" id="end" min="0" max="100" placeholder="end">
		<input type="button" value="조회" id="btn_find">
		<input type="button" value="전체조회" id="btb_list">
	</div>
	
	<hr>
	
	<c:forEach var="s" items="${top3}" varStatus="vs"> </c:forEach>
