...
public class BoardModifyService implements IBoardService {
	...
	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {   // request에는 파라미터 3개가 들어있음(수정: 제목, 내용, 번호)
		...
		// 4. 어디로 and 어떻게 이동	// 게시글의 번호값 필요함 (어떤 게시글을 조회할 것인지)
